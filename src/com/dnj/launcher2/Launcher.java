...
import com.dnj.launcher2.DropTarget.DragObject;
...
public final class Launcher extends Activity
    ...
    //功能键广播接受者
   private  BroadcastReceiver funkeyReceive;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
      ...
      IntentFilter filterRecv = new IntentFilter();
      filterRecv.addAction("android.intent.action.FUN_KEY");
      registerReceiver(funkeyReceive, filterRecv);
        if (PROFILE_STARTUP) {
    ...
    */
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	...
    	if(keyCode == 82 && event.isLongPress()){
    		Log.e("", "menu longpress");
    		//启动的应用程序包名
    		String pkg = "com.liankai.fenxiao";
    		//主类名
    		String cls = "com.liankai.fenxiao.activity.FrmMaster_";
...
//        }
    ...
    /* Cling related */
    private static final String PREFS_KEY = "com.dnj.launcher2.prefs";
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ...
                    SharedPreferences prefs =
                        getSharedPreferences("com.dnj.launcher2.prefs", Context.MODE_PRIVATE);
...
//	        	Toast.makeText(getApplicationContext(), "这是左侧下按键", 0).show();
	        }
	        
	        if(keycode == 134 && keydown){
//	        	Toast.makeText(getApplicationContext(), "这是右侧按键", 0).show();
	        }
...
//	        	Toast.makeText(getApplicationContext(), "这是F1按键", 0).show();
	    		...
	    		//主类名
	    		String cls = "com.android.contacts.activities.DialtactsActivity";
	    		ComponentName componet = new ComponentName(pkg, cls);
