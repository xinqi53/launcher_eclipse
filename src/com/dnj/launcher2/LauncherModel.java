...
import com.dnj.launcher.R;
import com.dnj.launcher2.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
        ...
        private void loadAllAppsByBatch() {
            ...
            while (i < N && !mStopped) {
                if (i == 0) {
                    ...
                    //获取所有的apps,要想过滤不显示某些app就在这里操作
                    apps = packageManager.queryIntentActivities(mainIntent, 0);
                    if(apps != null){
                    	int count = apps.size();
                    	int flag = 0;
                    	while(flag < count){
                    		String pakagerName = apps.get(flag).activityInfo.packageName;
                    		//不显示指定的程序
                    		if(pakagerName.equals("com.android.browser")
                    				|| pakagerName.equals("com.android.calculator2")
                    				|| pakagerName.equals("com.android.calendar")
                    				|| pakagerName.equals("com.android.camera")
                    				|| pakagerName.equals("com.android.contacts")
                    				|| pakagerName.equals("com.android.deskclock")
                    				|| pakagerName.equals("com.android.email")
                    				|| pakagerName.equals("com.android.gallery3d")
                    				|| pakagerName.equals("com.android.mms")
                    				|| pakagerName.equals("com.android.music")
                    				|| pakagerName.equals("com.android.settings")
                    				|| pakagerName.equals("com.android.soundrecorder")
                    				|| pakagerName.equals("com.mobint.hololauncher")
                    				|| pakagerName.equals("com.mediatek.videoplayer")
                    				|| pakagerName.equals("com.baidu.input")
                    				|| pakagerName.equals("com.qihoo.appstore")
                    				|| pakagerName.equals("com.android.providers.downloads.ui")
                    				|| pakagerName.equals("com.mediatek.filemanager")
                    				|| pakagerName.equals("com.android.quicksearchbox")
                    				){
                    			count--;
//                    			apps.remove(flag);
                    		}else{
